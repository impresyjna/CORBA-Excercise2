...
public class _UserServiceStub extends org.omg.CORBA.portable.ObjectImpl implements UserService
{
  ...
  public User createUser (User user)
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                User $result = UserHelper.read ($in);
                return $result;
  ...
  public User[] getUsers ()
  {
            ...
            try {
                ...
                $in = _invoke ($out);
                User $result[] = UsersHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
